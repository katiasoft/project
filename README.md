...
## 경력
* 회사명 : 펨트론
    - 기간 : 2021.02.01 ~ 2022.07.31
    - 직급 : 연구원 (SW R&D)
    - 주요업무 : MFC 언어를 사용하여 UI구성 및 C++언어를 사용하여 장비 제어, 각 업체에 대한 기능 개발 및 유지보수  
    - 참여한 프로젝트 : SPI 프로그램 버전 업그레이드, 삼성무선에 맞는 장비 프로그램 개발등
    
* 회사명 : (주)퍼블릭에이아이
    - 기간 : 2020.09.14 ~ 2021.01.31
    - 직급 : AI 개발자(인턴)
    - 주요 업무 : 이미지 처리 기술을 사용한 자율주행 프로젝트 참여 및 각종 교육 자료 작성(예시 : IT인프라, Docker등)
    - 참여한 프로젝트 : 자율주행자동차(현대), 일자리추천시스템(워크넷)
...
### ☞ 교육이수
* 국비지원 : 임베디드 소프트웨어 융합 풀스택 개발자 양성과정C
   - 기간 : 2023.02.27~2023.08.18
   - 내용 : Java, SpringBoot, MariaDB, HTML, CSS, JavaScript, Mybatis등
...
## 포트폴리오
### ☞ Deulsal-E
* 작업툴 : Java, SpringBoot, MariaDB, HTML, CSS, JavaScript, Python, Pandas등
* 인원 : 5명
* 기간 : 23.05.17 ~ 23.08.18
* 내용 : 공공데이터 포털의 전국 야영장 데이터를 사용하여 일반 사용자와 야영장 사업자를 연결 해주는 웹사이트
